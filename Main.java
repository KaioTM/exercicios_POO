...
public class Main {
	...
	public static void main(String[] args) {
		...
		// Falta criar a validação do triângulo e a resposta final
		/*if (Ax == Bx && Ay == By){
			System.out.print("As coordenadas informadas não formam um triângulo!");
		} else{
			if()
		};*/
